...
rem
rem  `app.series_match` and `app.serial_patterns` are NOT part of the import
rem  pipeline. Skipped, their work is simply absent from the result -- 3,273
rem  series matches and 498 serial designations -- with nothing to say so.
rem ---------------------------------------------------------------------------
setlocal
set "REPO=%~dp0.."
